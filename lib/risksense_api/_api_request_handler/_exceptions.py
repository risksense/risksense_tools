...
class InsufficientPrivileges(RequestFailed):
    """ Extension of RequestFailed class for Insufficient Privilege errors """


class UserUnauthorized(RequestFailed):
    """ Extension of RequestFailed class for User Unauthorized errors """


class NoMatchFound(RequestFailed):
    """ Extension of RequestFailed class for No Match Found errors """
