...
from .__subject.__scanners import Scanner
from .__subject.__aggregate import Aggregate
from .__subject.__role import Role
from .__subject.__ticket import Ticket
from .__subject.__rs3 import Rs3
from .__subject.__findinghistory import FindingHistory
...
class RiskSenseApi:
    ...
    def _instantiate_subjects(self):
        ...
        self.scanner= Scanner(self.__profile)
        self.aggregate= Aggregate(self.__profile)
        self.role= Role(self.__profile)
        self.ticket= Ticket(self.__profile)
        self.rs3=Rs3(self.__profile) 
        self.findinghistory=FindingHistory(self.__profile)                                          
        ...
        self.available_subjects = {
            ...
            "FindingHistory": self.findinghistory,
            "Groups": self.groups,
