""" *******************************************************************************************************************
|
|  Name        :  __host_unique_findings.py
|  Module      :  risksense_api
|  Description :  A class to be used for searching for Unique HostFindings on the RiskSense Platform.
...
class HostUniqueFindings(Subject):

    """ Host Unique Findings class """

    def __init__(self, profile):

        """
        Initialization of HostUniqueFindings object.
    ...
    def search(self, search_filters, page_num=0, page_size=150, sort_field=SortField.ID, sort_dir=SortDirection.ASC, client_id=None):
        ...
        """
        Searches for and returns unique host findings based on the provided filter(s) and other parameters.
        ...
        :param page_size:           The number of results that should be returned per page.
        :type  page_size:           int
    ...
    def export(self, search_filters, file_name, file_type=ExportFileType.CSV, comment="", client_id=None):
        ...
        """
        Initiates an export job on the platform for unique hostfinding(s) based
        on the provided filter(s).
        ...
        :return:    The job ID returned is returned.
        :rtype:     int
    ...
    def get_model(self, client_id=None):
        ...
        """
        Get available projections and models for HostUniqueFindings.

        :param client_id:   Client ID
        :type  client_id:   int

        :return:    HostUniqueFindings projections and models are returned.
        :rtype:     dict
