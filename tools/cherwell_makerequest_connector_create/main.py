...
class Cherwellconnectortool:
	...
	def __init__(self):
		...
		try:
			self.connector_id = self.rs.connectors.create_cherwell_makerequest_connector(self.cherwellname,self.cherwell_username,self.cherwell_password,self.cherwell_clientidkey,self.cherwellurl,client_id=None)			
