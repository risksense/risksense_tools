...
class qualyspccreate:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_qualyspc(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,auto_urba=self.autourba,hour_of_day=self.hourofday,day_of_month=self.dayofmonth,day_of_week=self.dayofweek,reportnameprefix=self.reportnameprefix)
