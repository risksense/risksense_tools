...
class HfReportFromFilter:
    ...
    def __init__(self):
        ...
        try:
            returned_hosts = self.rs.hosts.search(filter_defn, projection=rsapi.Projection.BASIC, page_size=1000)
        ...
        self.write_csv_file(returned_hosts, self.csv_output_filename)
    ...
    def get_filter_defn(self, filter_name):
        ...
        try:
            returned_filters = self.rs.filters.list_host_filters()
        except (rsapi.MaxRetryError, rsapi.StatusCodeError, rsapi.PageSizeError,
