...
class Aggregate(Subject):
    ...
    def get_topransomwarefamilies(self,filters=[],client_id=None):
        ...
        if filters!=[]:
            body={"subject":"hostFinding","filters":[filters,{"field":"generic_state","exclusive":False,"operator":"EXACT","orWithPrevious":False,"implicitFilters":[],"value":"Open"},{"field":"threat_categories","operator":"EXACT","exclusive":False,"orWithPrevious":False,"implicitFilters":[],"value":"Ransomware"},{"field":"cve_data","exclusive":False,"operator":"NESTED","value":"[{\"field\":\"cve_data.has_ransomware\",\"operator\":\"EXACT\",\"exclusive\":false,\"orWithPrevious\":false,\"implicitFilters\":[],\"value\":\"true\"}]"}],"size":1000}
        if filters==[]:
