...
class qualysvmcreate:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_qualys_vmdr(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,auto_urba=False,hour_of_day=0,day_of_week=self.dayofweek,day_of_month=self.dayofmonth)
