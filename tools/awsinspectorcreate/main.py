...
class awsinspectorcreate:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_awsinspector(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,hour_of_day=self.hourofday,day_of_week=self.dayofweek,day_of_month=self.dayofmonth,create_asset=True)
