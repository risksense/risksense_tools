...
class Aggregate(Subject):
    ...
    def get_unique_findings_by_severity(self,filter,client_id=None):
        """
        ...
        url = self.aggregate_url.format(str(client_id))+"/uniqueFindingInfoBySeverity/aggregate"

        try:
            raw_response = self.request_handler.make_request(ApiRequestHandler.POST,body=filter,url=url)
    ...
    def top_25_cwe(self,filter,client_id=None):
        """
        Get groupby values for host finding
        ...
        url = self.aggregate_url.format(str(client_id))+"/topCWEBySoftwareError/aggregate"
    ...
    def owasp_distribution(self,filter,client_id=None):
        """
        Get groupby values for host finding
        ...
        url = self.aggregate_url.format(str(client_id))+"/openFindingByOwasp/aggregate"
    ...
    def top10uniquefindingsbyseverity(self,filter,client_id=None):
        """
        Get groupby values for host finding
        ...
        url = self.aggregate_url.format(str(client_id))+"openTopUniqueFindingBySeverity/aggregate"
    ...
    def get_findings_applicationfinding(self,duration,filter=[],client_id=None):
        """
        Get groupby values for host finding
        ...
        url = self.aggregate_url.format(str(client_id))+'findingDateHistogram/aggregate'
        if filter==[]:
