...
class sonarcloudcreate:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_sonar_cloud(self.connector_name,self.connectorurl,self.scheduletype,self.networkid,self.username,self.password,auto_urba=False)
