...
class checkmarxsast:
    ...
    def __init__(self):
        ...
        try:
            connector_details=self.rs.connectors.create_checkmarx_sast_connector(self.connector_name,self.connectorurl,self.username,self.password,False,self.scheduletype,self.networkid,hour_of_day=self.hourofday)
